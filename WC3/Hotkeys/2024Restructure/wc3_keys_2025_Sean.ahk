...
FrontMouseButtonKey := "XButton2"  ;Standard key would be XButton2 - This is referring to the side mouse button that is farther from the palm of the hand
BackMouseButtonKey := "XButton1"  ;Standard key would be XButton1 - This is referring to the side mouse button that is closer to the palm of the hand
MouseWheelRight := "WheelRight"
MouseWheelScrollUp := "WheelUp"
MouseWheelScrollDown := "WheelDown"
;sean -- updated for my mouse buttons
...
HotKey, *%MouseWheelRight%, MouseWheelRightHandler
...
;;;;;; For resource trading - Tab instead of F11. Tab also closes the menu (usually it would just open it and enter to close)
*Tab::
...
setMacroModeRemappings()
{
  ...
  HotKey, %BackMouseButtonKey% & V, MacroVHandler
}
MacroEHandler:
Send, u
return
...
;;;;;; Make left thumb click button (y) for camera grip
*y::MButton

;;;;;; Make WheelLeft be quickcast attack
*WheelLeft::
Send, l
Send {LButton}
return
...
;;;;;; Previously Had Move Command on WheelRight
;WheelRight:
;Send, b
;Send {LButton}
return
...
;;;;;;; Scroll Wheel Down as Level Up Ability
...
;Sean -- adding my usual pause and kill hotkeys stock code here:
...
;seanfix -- just make sure this key combination doesn't come up in game. Othwerwise will need to use something more obscure
;;;;;; Kill the app
^+*x::
Suspend, Permit
